    ...
    <div @mouseup="handleMouseSelect">
        ...
        <div class="sssss">
            ...
            <div :style="{ left: left + 'px', top: top + 'px' }" v-if="menu" @mouseleave="out2" @mouseover.capture="over2"
                ...
                <div class="doctable">
                    <el-container class="titlea">
                        <el-aside>
                            <el-tabs type="border-card">
                                <el-tab-pane label="文档详情" name="tab_first" style="height: 380px">
                                    <div>
                                        <p><strong>标题</strong> {{ this.title }}</p>
                                    </div>
                                    <div style="padding-top: 10px">
                                        <p><strong>大小</strong> {{ this.size }}</p>
                                    </div>
                                    <div style="padding-top: 10px">
                                    ...
                                    <div style="padding-top: 10px">
                                        <p><strong style="vertical-align: bottom;">索引状态</strong>
                                            ...
                                            <Button style="margin-left: 10px" v-else-if="this.docState === 'WAITE'"
                                                type='info' size="small"
                                                @click="infoVisible ? infoVisible = false : infoVisible = true">
                                                等待
                                            </Button>
                                            <Button style="margin-left: 10px" v-else-if="this.docState === 'ON_PROCESS'"
                                        ...
                                        <div v-show="infoVisible"
                                            ...
                                            <span v-if="this.docState === 'SUCCESS'">
                                                ...
                                                您可以选择 <span style="color: #dc4e2b; cursor: pointer"
                                                    @click="rebuildIndex(this)">重建索引</span>。
                                            </span>
                                            <span v-else-if="this.docState === 'WAITE'">
                                                等待中，请稍等。您可以选择 <span style="color: #dc4e2b; cursor: pointer"
                                                    @click="rebuildIndex(this)">重建索引</span>。
                                            </span>
                                            <span v-else-if="this.docState === 'ON_PROCESS'">
                                                正在进行中，请稍等
                                            </span>
                                            <span v-else>
                                    ...
                                    <div style="padding-top: 10px">
                                        <p><strong style="padding-top: 10px;">创建人</strong> {{ this.userName }}
                                        </p>
                                    </div>
                                    <div style="padding-top: 10px">
                                    ...
                                    <div style="padding-top: 10px">
                                        ...
                                        <p v-if="this['tags'] === undefined || this['tags'].length < 1">
                                            无标签</p>
                                        <Tag :color="item.color" v-else v-for="item in this['tags']" :index="item.index">{{
                                            item.name
                                        }}
                                        </Tag>
                                    </div>
        ...
        init() {
            ...
            DocRequest.getData(params).then(response => {
                if (response.code === 200) {
                  ...
                  console.log("失败了response为：",response)
                }
            })
        },
