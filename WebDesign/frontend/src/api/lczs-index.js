...
function iningj(type){
    ...
    htmls+="<button onclick='addinput()'><img src='/bootstrop/images/seach-gj03.png' /></button> ";
    if(type==0){
    	htmls+="<button onclick='remove(this)'><img src='/bootstrop/images/seach-gj04.png' /></button> ";
    }
    htmls+="</div>";
