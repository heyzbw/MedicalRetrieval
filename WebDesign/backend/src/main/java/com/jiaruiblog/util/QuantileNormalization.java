...
//        for (EsSearch doc : documents) {
//            if ("like".equals(attribute)) {
//                Double likeScore = quantiles.get((double) doc.getLike_num());
//                if (likeScore != null) {
//                    doc.setLikeScore(likeScore);
//                } else {
//                    doc.setLikeScore(0.0); // Provide a default value, for example, 0.0
//                }
//            } else {
//                Double clickScore = quantiles.get((double) doc.getClick_num());
//                if (clickScore != null) {
//                    doc.setClickScore(clickScore);
//                } else {
//                    doc.setClickScore(0.0); // Provide a default value, for example, 0.0
//                }
//            }
//        }
//    }
